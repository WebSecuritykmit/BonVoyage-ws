					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="reviewratings.jsp">Rate reviews</a></li>
								<li class="dropdown">
	  ...
	  <div class="agile_overlay2">
	    <div class="container"> 
			<div class="wthree_head_section">
				...
				<p class="ppp">You will always have fascinating places to be and friendly people to see.</p>
			</div>
			...
			<div class="footer-btm-agileinfo">
				...
				<div class="col-md-3 col-xs-3 footer-grid">
					...
					<ul>
						...
						<li><i class="fa fa-phone"></i>Hyderabad,India</li>
